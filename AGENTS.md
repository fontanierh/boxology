...
Record the reconciliation in the pull request or closing issue comment. The full design rule is documented in [Quality and Authority](module-based-engineering-details/06-quality-and-authority.md#tracker-reconciliation-gate).
