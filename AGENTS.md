...
2. **Stream specs and task lists.** Each stream receives a spec, reviewed and merged before its implementation starts. The spec produces the stream's task list as tracker issues referencing the stream.
