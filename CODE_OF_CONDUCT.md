...
officially representing the community in public spaces. Examples include using an official email
...
through [GitHub private vulnerability reporting](https://github.com/fontanierh/boxology/security/advisories/new),
which also accepts Code of Conduct reports and will be enabled before the repository becomes public.
