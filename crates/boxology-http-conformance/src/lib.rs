...
d2/syntax-preserves-duplicates-and-order :: spec :: preserves duplicate keys and key order :: wire h:duplicate-key-object f:crates/boxology-contract/src/json/semantic.rs#duplicate_map_keys_win_before_value_lowering_without_leaking f:crates/boxology-http/src/replay_tests.rs#blob_duplicate_keys_precede_payload_decoding
...
d2/semantic-role-aware :: spec :: strict `ProviderInput`, tolerant `ConsumerOutput` :: wire f:crates/boxology-contract/src/json/semantic.rs#supported_boundaries_decode_in_both_roles f:crates/boxology-http/src/replay_tests.rs#aggregate_bytes_preserve_order_roles_and_unknown_enum_opacity f:crates/boxology-http/src/client.rs#result_and_domain_payloads_are_consumer_tolerant
d2/descriptor-directed-representation :: spec :: resolving descriptor-directed representation :: wire f:crates/boxology-contract/src/json/semantic.rs#wide_integer_strings_are_canonical_and_range_checked f:crates/boxology-http/src/replay_tests.rs#blob_bytes_replay_canonical_vectors_in_both_roles f:crates/boxology-contract/src/json/semantic.rs#known_enums_decode_all_supported_payload_shapes_and_orders
d2/reject-duplicate-keys :: spec :: rejecting duplicate keys :: wire h:duplicate-key-object f:crates/boxology-contract/src/json/semantic.rs#duplicate_map_keys_win_before_value_lowering_without_leaking f:crates/boxology-http/src/replay_tests.rs#strict_struct_bytes_preserve_duplicate_role_and_conformance_precedence
d2/reject-noncanonical-integers :: spec :: non-canonical integer strings :: wire h:noncanonical-integer f:crates/boxology-contract/src/json/semantic.rs#integer_rejections_are_exact_and_payload_free f:crates/boxology-contract/src/json/semantic.rs#wide_integer_strings_are_canonical_and_range_checked
d2/encode-is-canonical-reverse :: spec :: Encode is the reverse: `ContractValue` :: wire f:crates/boxology-contract/src/json/encode.rs#canonical_scalar_goldens_replay_byte_identically f:crates/boxology-http/src/replay_tests.rs#scalar_bytes_replay_every_width_boundary_and_string_form
...
d3/utf8-no-insignificant-whitespace :: spec :: UTF-8; no insignificant whitespace :: wire f:crates/boxology-contract/src/json/encode.rs#canonical_scalar_goldens_replay_byte_identically n:raw_hello/raw_hello_cases_are_canonical
d3/struct-keys-descriptor-order :: spec :: struct keys in descriptor field order :: wire f:crates/boxology-contract/src/json/encode.rs#aggregates_have_exact_canonical_bytes_and_replay f:crates/boxology-contract/src/json/encode.rs#top_level_and_struct_presence_are_exact
d3/envelope-key-sequences-fixed :: spec :: envelope key sequences fixed exactly :: wire f:crates/boxology-contract/src/json/encode.rs#blob_presence_and_hello_envelopes_are_exact f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free h:exact-success
d3/map-keys-sorted-bytewise :: spec :: map keys sorted bytewise :: wire f:crates/boxology-contract/src/json/encode.rs#aggregates_have_exact_canonical_bytes_and_replay
d3/escaping-exact :: spec :: escaping exactly :: wire f:crates/boxology-contract/src/json/encode.rs#strings_use_exact_d3_escaping
d3/f64-ryu-shortest :: spec :: `f64` via Ryu-shortest :: wire f:crates/boxology-contract/src/json/encode.rs#floats_use_descriptor_width_ryu_goldens
d3/f32-ryu-f32-mode :: spec :: `f32` via Ryu's f32 mode :: wire f:crates/boxology-contract/src/json/encode.rs#floats_use_descriptor_width_ryu_goldens
d3/base64-standard-padded-strict :: spec :: Base64 standard alphabet with padding :: wire f:crates/boxology-contract/src/json/encode.rs#blob_presence_and_hello_envelopes_are_exact f:crates/boxology-http/src/replay_tests.rs#blob_bytes_reject_noncanonical_representations_without_leakage
d3/no-trailing-newline :: spec :: no trailing newline :: wire f:crates/boxology-contract/src/json/encode.rs#canonical_scalar_goldens_replay_byte_identically h:exact-success
d3/golden-vectors-gating :: spec :: Golden byte vectors for every scalar edge :: wire f:crates/boxology-contract/src/json/encode.rs#canonical_scalar_goldens_replay_byte_identically f:crates/boxology-contract/src/json/encode.rs#floats_use_descriptor_width_ryu_goldens f:crates/boxology-http/src/replay_tests.rs#scalar_bytes_replay_every_width_boundary_and_string_form f:crates/boxology-http/src/replay_tests.rs#blob_bytes_replay_canonical_vectors_in_both_roles
d3/byte-identity-encoder-output-only :: spec :: Byte-identity claims apply to canonical encoder output only :: wire f:crates/boxology-contract/src/json/encode.rs#requests_are_bare_canonical_values_and_replay_as_provider_input f:crates/boxology-http/src/replay_tests.rs#scalar_bytes_replay_every_width_boundary_and_string_form
...
d5/stable-wire-codes-named :: spec :: unknown_box`, `unknown_capability`, `invalid_request` :: wire h:unknown-box h:unknown-capability h:malformed-json h:get-method h:oversized-content-length h:missing-content-type f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free
d5/service-statuses-carry-call-error-envelope :: spec :: Every service-generated invocation status carries the call-error :: wire h:get-method h:oversized-content-length h:application-xml-media-type f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free
...
d5/handler-cancelled-maps-internal :: spec :: handler-returned `Cancelled` :: wire f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free s:internal
...
d6/response-content-type-json-only :: spec :: Responses: `Content-Type: application/json` only :: wire h:exact-success f:crates/boxology-contract/src/json/encode.rs#blob_presence_and_hello_envelopes_are_exact
...
rt/strings-booleans-json :: runtime :: Strings and booleans use their JSON equivalents :: wire f:crates/boxology-contract/src/json/semantic.rs#supported_boundaries_decode_in_both_roles f:crates/boxology-contract/src/json/encode.rs#canonical_scalar_goldens_replay_byte_identically h:exact-success
rt/integers-32-json-numbers :: runtime :: Integers through 32 bits and finite floating-point values :: wire f:crates/boxology-contract/src/json/semantic.rs#supported_boundaries_decode_in_both_roles f:crates/boxology-contract/src/json/semantic.rs#finite_floats_decode_at_the_declared_width_in_both_roles f:crates/boxology-http/src/replay_tests.rs#scalar_bytes_replay_every_width_boundary_and_string_form
rt/nonfinite-floats-invalid :: runtime :: a non-finite request value is invalid input :: wire f:crates/boxology-contract/src/json/semantic.rs#float_failures_are_exact_payload_free_and_role_symmetric f:crates/boxology-contract/src/json/encode.rs#floats_use_descriptor_width_ryu_goldens
rt/i64-u64-decimal-strings :: runtime :: `i64` and `u64` use decimal JSON strings :: wire f:crates/boxology-contract/src/json/semantic.rs#wide_integer_strings_are_canonical_and_range_checked f:crates/boxology-http/src/replay_tests.rs#scalar_bytes_replay_every_width_boundary_and_string_form
rt/string-keyed-maps-only :: runtime :: Other map-key types are not supported by this binding :: wire f:crates/boxology-contract/src/json/semantic.rs#lists_and_maps_preserve_empty_order_nested_values_and_optional_nulls f:crates/boxology-contract/src/json/semantic.rs#recursive_support_inventory_is_complete_before_payload_inspection
rt/binary-base64-object :: runtime :: Bounded binary values use `{"base64":"..."}` :: wire f:crates/boxology-http/src/replay_tests.rs#blob_bytes_replay_canonical_vectors_in_both_roles f:crates/boxology-contract/src/json/encode.rs#blob_presence_and_hello_envelopes_are_exact
rt/streaming-binary-outside-unary :: runtime :: Streaming binary values are outside the unary foundation binding :: post:100
rt/enum-tag-payload :: runtime :: Every enum uses `{"tag":"variant","payload":...}` :: wire f:crates/boxology-contract/src/json/semantic.rs#known_enums_decode_all_supported_payload_shapes_and_orders f:crates/boxology-contract/src/json/encode.rs#known_enums_and_domain_errors_have_exact_recursive_bytes s:domain-empty-name
rt/object-required-rejects-null :: runtime :: `T` is required and rejects `null` :: wire f:crates/boxology-contract/src/json/semantic.rs#structs_apply_presence_recursion_roles_and_input_order f:crates/boxology-http/src/replay_tests.rs#presence_bytes_replay_top_fields_children_and_nested_wrappers
rt/object-option-omission-none :: runtime :: `Option<T>` maps omission to `None` and rejects explicit `null` :: wire f:crates/boxology-contract/src/json/semantic.rs#structs_apply_presence_recursion_roles_and_input_order f:crates/boxology-http/src/replay_tests.rs#presence_bytes_replay_top_fields_children_and_nested_wrappers
rt/object-field-three-states :: runtime :: `Field<T>` maps omission to `Missing`, `null` to `Null` :: wire f:crates/boxology-contract/src/json/semantic.rs#structs_apply_presence_recursion_roles_and_input_order f:crates/boxology-http/src/replay_tests.rs#presence_bytes_replay_top_fields_children_and_nested_wrappers f:crates/boxology-contract/src/json/encode.rs#top_level_and_struct_presence_are_exact
rt/toplevel-option-null :: runtime :: At the top level, `Option<T>` uses JSON `null` for `None` :: wire f:crates/boxology-contract/src/json/semantic.rs#top_level_presence_wrappers_preserve_null_and_value_without_missing f:crates/boxology-contract/src/json/encode.rs#top_level_and_struct_presence_are_exact
...
rt/result-envelope :: runtime :: {"result":{"value":"..."}} :: wire h:exact-success s:ok-result f:crates/boxology-contract/src/json/encode.rs#blob_presence_and_hello_envelopes_are_exact
rt/domain-error-envelope :: runtime :: {"error":{"kind":"domain","value" :: wire s:domain-empty-name f:crates/boxology-contract/src/json/encode.rs#known_enums_and_domain_errors_have_exact_recursive_bytes n:typed_hello/typed_hello_round_trips_success_and_domain_error
rt/call-error-envelope :: runtime :: {"error":{"kind":"call","code":"invalid_request" :: wire h:malformed-json f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free
rt/domain-errors-422 :: runtime :: Declared domain errors always return `422` :: wire s:domain-empty-name n:typed_hello/typed_hello_round_trips_success_and_domain_error f:crates/boxology-contract/src/json/encode.rs#known_enums_and_domain_errors_have_exact_recursive_bytes
...
rt/status-503 :: runtime :: `503` | Bound target unavailable. :: wire s:unavailable f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free
...
rt/status-500 :: runtime :: `500` | Internal runtime failure. :: wire s:internal f:crates/boxology-http/src/encoder.rs#call_error_mapping_and_envelopes_remain_exact_and_payload_free
