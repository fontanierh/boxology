...
ac1/suite-green-native :: spec :: Conformance suite green on both platforms :: wire n:raw_hello/raw_hello_cases_are_canonical n:raw_server/raw_server_client_cases_are_canonical n:typed_hello/typed_hello_round_trips_success_and_domain_error
ac1/cross-platform-reproof-post-v0 :: spec :: cross-platform re-proof is owned by [#525] :: post:525
...
pub const SPEC_AUTHORITY_DIGEST: u64 = 0x53c4f190e98b7fba;
