    ...
    > {
        ...
        if capability == capabilities[9].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::ListenStartRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::TelegramDispatch::listen_start(
                        &self.service,
                        context,
                        input,
                    )
