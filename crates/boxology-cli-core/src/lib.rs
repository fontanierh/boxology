...
//! Trusted lock/fmt/Clippy/test/quality steps use an injectable runner; tool output is outside determinism claims.
#![deny(missing_docs)]
#![forbid(unsafe_code)]
...
pub use base::{
    ...
    ResolvedBase, base_diff_inputs, base_diff_inputs_with_candidate, base_package_schemas,
    resolve_base, resolve_default_base,
};
pub use check::{
...
pub use runner::{
    ...
    run_lock_step, run_quality_step, run_test_step, test_spec,
};
