...
/// Generator package version captured by Cargo at compile time.
...
pub fn generate(request: GenerationRequest) -> Result<GeneratedTree, Diagnostics> {
    ...
    let manifest = if release_contract {
        ...
        format!(
            "[package]\nname = \"{}-contract\"\nversion.workspace = true\nedition.workspace = true\nrust-version.workspace = true\nlicense.workspace = true\nrepository.workspace = true\nhomepage.workspace = true\nreadme.workspace = true\ndescription = {description:?}\npublish = true\n\n[features]\ndefault = []\ntest-support = []\n\n[dependencies]\nboxology-contract = {{ version = \"=0.2.1\", path = \"../../../boxology-contract\" }}\n",
...
mod tests {
    ...
    const RUST: &[u8] = br#"// Generated by boxology-generator @VERSION@
#[rustfmt::skip]
...
"#;
    ...
    fn cold_hello_bytes_are_exact_and_parseable() {
        assert_eq!(GENERATOR_VERSION, env!("CARGO_PKG_VERSION"));
        ...
        assert!(rust.starts_with(&format!(
            "// Generated by boxology-generator {GENERATOR_VERSION}\n"
        )));
        ...
        let body_start = rust[header_end..]
            ...
            .unwrap();
        let mut without_descriptor = b"// Generated by boxology-generator @VERSION@\n".to_vec();
...
"#;
        ...
        let schema = SCHEMA_TEMPLATE
            ...
            .replace("{REVISION}", &independently_hashed);
...
"#;
    ...
    fn generated_structured_contract_routes_and_preserves_unknown_outputs() {
        ...
        fs::write(
            ...
            format!(
                "[workspace]\nmembers=[\"generated/contract\",\"implementation\"]\nresolver=\"3\"\n[workspace.dependencies]\nboxology={{path={:?}}}\nboxology-contract={{version=\"=0.2.1\",path={:?}}}\nboxology-runtime={{version=\"=0.2.1\",path={:?},features=[\"test-support\"]}}\n",
...
"#,
    ...
    fn generated_import_adapter_typed_imports_compile_and_fail_unsealed() {
        ...
        fs::write(
            root.join("Cargo.toml"),
            format!(
                "[workspace]\nmembers=[\"generated/contract\",\"implementation\"]\nresolver=\"3\"\n[workspace.dependencies]\nboxology={{path={:?}}}\nboxology-contract={{version=\"=0.2.1\",path={:?}}}\nboxology-runtime={{version=\"=0.2.1\",path={:?}}}\n",
                workspace.join("boxology"),
                workspace.join("boxology-contract"),
                workspace.join("boxology-runtime"),
            ),
