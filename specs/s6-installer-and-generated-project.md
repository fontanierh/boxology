...
**Amendment of 2026-08-04 (#522 reconciliation).** D5/AC1 Linux-and-macOS V0 byte-determinism evidence reads as native macOS ARM64 V0 evidence for the continuous gate; cross-platform re-proof is owned by [#525](https://github.com/fontanierh/boxology/issues/525). Born-valid remains the one native-macOS behavioral run.
