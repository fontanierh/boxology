...
- Its top-level `--help` path prints the stable initializer usage to stdout without a diagnostic and exits `0`; malformed invocations retain the `BXI0009` diagnostic, usage on stderr, and exit `2`.
