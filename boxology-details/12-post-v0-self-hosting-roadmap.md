...
configured xAI implementation, and root-confined typed read/write/edit operations.
Bounded bash is the next tool slice. Sessions/compaction, the agent loop, JSON/RPC,
