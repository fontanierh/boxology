...
Boxology `0.2.0` tools are published on crates.io. Building this checkout requires Rust 1.97.1.
...
`cargo install --force boxology-cli --locked`; add `--version 0.2.0` to pin this release.
...
exact `0.2.0` closure and order, inspects every crate's planned file inventory (including README and
