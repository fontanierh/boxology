...
Boxology `0.2.2` tools are published on crates.io. Building this checkout requires Rust 1.97.1.
...
`cargo install --force boxology-cli --locked`; add `--version 0.2.2` to pin this release.
...
exact `0.2.2` closure and order, inspects every crate's planned file inventory (including README and
